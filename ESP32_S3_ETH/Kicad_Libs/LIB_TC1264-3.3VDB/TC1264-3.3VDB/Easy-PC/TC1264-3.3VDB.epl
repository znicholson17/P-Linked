...
(library Library_1
	...
	(symbolDef "TC1264-3_3VDB" (originalName "TC1264-3_3VDB")
	...
	(compDef "TC1264-3.3VDB" (originalName "TC1264-3.3VDB") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TC1264-3_3VDB"))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/devicedoc/21375d.pdf")
		(attr "Height" "1.8 mm")
	)
